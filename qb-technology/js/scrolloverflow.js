...
/*!
* Scrolloverflow 2.0.2 module for fullslides.js >= 3
* https://github.com/alvarotrigo/fullslides.js
...
(function (window, document) {
    window.fp_scrolloverflow = (function() {
        ...
        */
        ...
        function scrollBarHandler(){
            ...
            self.init = function(options, iscrollOptions){
                ...
                if(document.readyState === 'complete'){
                    ...
                    fullslides_api.shared.afterRenderActions();
                }
         ...
         * to the fullslides.js option that implements the same functions
         * as this handler.
         *
         * @type {Object}
         */
        var $ = null;
        var g_fullslidesOptions = null;
        var iscrollHandler = {
            refreshId: null,
            iScrollInstances: [],
            ...
            update: function(element, scrollHeight) {
                ...
                iscrollHandler.refreshId = setTimeout(function(){
                    iscrollHandler.iScrollInstances.forEach(function(instance){
                        ...
                        //otherwise done on the fullslides.js reBuild function
                        fullslides_api.silentMoveTo(fp_utils.index($(SECTION_ACTIVE_SEL)[0]) + 1);
                    });
                }, 150);
                ...
                if(g_fullslidesOptions.verticalCentered){
